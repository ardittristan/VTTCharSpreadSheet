...
import joinRows from '../core/join-rows.js';
import Handler from './handler.js';
import { isArray, isObject } from '../core/helper.js';
import escapedDelimiters from '../core/escape-delimiters.js';
...
var Parser = function () {
  class Parser {
    constructor(options) {
      ...
      this._escape = escapedDelimiters(this._options.textDelimiter, this._options.rowDelimiter, this._options.forceTextDelimiter);
    }
  }
  ...
  _createClass(Parser, [{
    ...
    value: function parse(json, done, stream) {
      if (isArray(json)) return done(null, this._parseArray(json, stream));else if (isObject(json)) return done(null, this._parseObject(json));
